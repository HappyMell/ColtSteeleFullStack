...
// Reviews New
router.get("/new", middleware.isLoggedIn, middleware.reviewExistence, function (req, res) {
...
// Reviews Create
router.post("/", middleware.isLoggedIn, middleware.reviewExistence, function (req, res) {
...
// Reviews Edit
router.get("/:review_id/edit", middleware.reviewOwnership, function (req, res) {
...
// Reviews Update
router.put("/:review_id", middleware.reviewOwnership, function (req, res) {
...
// Reviews Delete
router.delete("/:review_id", middleware.reviewOwnership, function (req, res) {
